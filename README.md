...
See [supported chains](./skill/SKILL.md#supported-chains) and [contract addresses](./config.json).

## 🚀 Get Started

1. **AI agents**: Use the [Spot Advanced Swap Orders skill](./skill/SKILL.md), available on [Clawhub](https://clawhub.ai/eranp-orbs/spot-advanced-swap-orders), or connect to the [hosted MCP endpoint](https://agents-sink.orbs.network/mcp).
...
Spot's contracts were audited by AstraSec: [initial audit](./Audit-AstraSec.pdf) and [updated audit](./Audit2-AstraSec.pdf).
