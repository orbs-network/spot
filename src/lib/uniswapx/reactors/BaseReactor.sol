...
abstract contract BaseReactor is IReactor, ReactorEvents, ReentrancyGuard {
    ...
    function _resolve(SignedOrder calldata order) internal virtual returns (ResolvedOrder memory resolvedOrder);
