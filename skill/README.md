...
See the [external Spot integration docs](https://spot-integration-docs.vercel.app/) for API, TypeScript, React, and swap-routing guides. Agents should follow the [Spot Advanced Swap Orders skill](https://github.com/orbs-network/spot/blob/master/skill/SKILL.md).
